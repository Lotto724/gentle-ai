...
| Match thread language | Write in the thread/user language. If a higher-priority persona or task instruction specifies artifact language, follow it. Otherwise, if writing in Spanish, use Rioplatense Spanish/voseo: `podés`, `tenés`, `fijate`, `dale`. |
